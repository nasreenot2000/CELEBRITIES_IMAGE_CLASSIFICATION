...
image_dir = 'cropped'
messi = os.listdir('cropped\\lionel_messi')
maria = os.listdir('cropped\\maria_sharapova')
roger = os.listdir('cropped\\roger_federer')
serena = os.listdir('cropped\\serena_williams')
virat = os.listdir('cropped\\virat_kohli')
...
image_paths_to_predict = [
     'cropped\\lionel_messi\\lionel_messi1.png',
     'cropped\\maria_sharapova\\maria_sharapova1.png',
     'cropped\\roger_federer\\roger_federer1.png',
     'cropped\\serena_williams\\serena_williams2.png',
     'cropped\\virat_kohli\\virat_kohli1.png'
